...
<head>
    ...
    <link rel="stylesheet" href="../css/comp">
    <title>Pizza calabresa comum</title>
...
<body class="bodypizza">
   <?php 
     ...
     $ValorDaComprar =  $PizzaCalabresa * $Quantidade ;
     echo"<div class='comprar'>
     <h1 class='titulodecomprarrealizda'>Sua compra foi realizada com sucesso</h1>
       <h2>O valor a ser pago é R$ $ValorDaComprar por $Quantidade pedidos</h2>
